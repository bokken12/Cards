...
public interface Constants {
    ...
    public static final int LANE_1_END_Y = 600;
    public static final int LANE_2_START_X = 473;
    public static final int LANE_2_START_Y = 110;
    public static final int LANE_2_END_X = 700;
    public static final int LANE_2_END_Y = 600;
    public static final int LANE_3_START_X = 855;
