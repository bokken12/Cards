...
public class MetaClass {
  ...
  public static <E> E cast(String value, Type type){
    ...
    if(String.class.isAssignableFrom(clazz)){
      ...
      try {
        return (E) new BufferedReader(new FileReader(value));
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
      ...
      if (value.equalsIgnoreCase("stderr") || value.equalsIgnoreCase("err")) { return (E) System.err; }
      try {
        return (E) new PrintWriter(new PrintStream(value));
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
      ...
      try {
        ...
        return (E) new FileOutputStream(value);
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
      ...
      try {
        return (E) new BufferedInputStream(new FileInputStream(value));
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
    } else {
